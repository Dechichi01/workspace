...
public class Main {
	...
	{	
		System.out.println("Static test: Funcionários\nPiso Salarial = R$ 1000,00");
		...
		System.out.println("Novo técnico (Valor hora extra = 10)");
		Tecnico.setValorHoraExtra(10);
		Tecnico t = new Tecnico();
		
		Funcionario.setPercentBonificacao(.3);
		System.out.println("Dado percentBonificacao = .3\n");
		System.out.println("Salário Professor: " + p.calcSalario()
		+ "\nSalário Ténico (10 horas extras): " + t.calcSalario(10) + "\n");
